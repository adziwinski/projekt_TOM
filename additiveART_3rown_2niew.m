function [ ] = additiveART_3rown_2niew( A,G,F,x,errorSize)
    ...
    subplot(1,2,1)
     ...
     xlabel('x')
     ylabel('y')
     legend('równanie 1', 'równanie 2', 'równanie 3', '\lambda = const', 'Location' , 'southwest')
     grid minor
     text(1.5,1.5,'Punkt startowy (1,5, 1,5)  ','HorizontalAlignment', 'right')
    ...
    subplot(1,2,1)
     ...
     xlabel('x')
     ylabel('y')
     legend('równanie 1', 'równanie 2', 'równanie 3', '\lambda zmniejszana w ka¿dej iteracji','Location' , 'southwest')
     grid minor
     text(1.5,1.5,'Punkt startowy (1,5, 1,5)  ','HorizontalAlignment', 'right')

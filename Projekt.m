...
switch choice
    ...
    case 2
        ...
        subplot(1,2,2)
         ...
         axis('square')
         title('Błąd oszacowania i-tej iteracji');
         xlabel('i')
         ylabel('błąd')
         grid on
         grid minor
...
%% Pytania:
% Czy ja te rozwiązania w dobrym miejscu wpisuję do puli rozwiązań?
% Wydaje mi się, że dobrze, bo pierwsza AA ART wykonuje od razu zmianę 
% x i y, a MART wykonuje najpierw x a w następnym kroku dopiero y

% Jak zrobić 2 równania i 3 niewiadome??
% Jaki jest z??
%% 3 równania 2 niewiadome
    case 4
        AA = [5.05 0.5; 0.1 1; 2 1];
        GG = [8.8421; 1.9721; 4.3452];
        FF = AA\GG; % równanie jest sprzeczne. FF to rozwiązanie średniokwadratowe
...
%% 2 równania 3 niewiadome
    case 5
        %AAA = [5.05 0.5 1; 0.1 1 2]; %wychodzi źle

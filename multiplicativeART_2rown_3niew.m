function [ ] = multiplicativeART_2rown_3niew(A,G,x,z,errorSize)
    ...
    text(-0.2, 1.15, {'Algorytm Multiplicative ART (2 równania i 3 niewiadome)','\lambda = const.'}, 'HorizontalAlignment', 'center',...
    ...
    text(-0.2, 1.15, {'Algorytm Multiplicative ART (2 równania i 3 niewiadome)','\lambda zminiejszana w ka¿dej iteracji'}, 'HorizontalAlignment', 'center',...
        'FontSize', 16 , 'Units', 'normalized');
    ...
    text(-0.2, 1.2, {'Algorytm Multiplicative ART (2 równania i 3 niewiadome)'}, 'HorizontalAlignment', 'center',...
        'FontSize', 16 , 'Units', 'normalized')
end

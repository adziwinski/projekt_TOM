function [ ] = additiveART_2rown_2niew( A,G,x,errorSize, maxAmountOfInterations, startPoint,lambdaInitValue, lambdaDivideCoeff)
    ...
    subplot(1,2,1)
     ...
     legend(sprintf('równanie y = %.1f*x + %.1f', A(1,1)/A(1,2), G(1)/A(1,2)),... 
            sprintf('równanie y = %.1f*x + %.1f', A(2,1)/A(2,2), G(2)/A(2,2)), 'wynik w i-tej iteracji', 'Location' , 'southwest')
